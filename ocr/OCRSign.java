...
//	 传入签名参数
public OCRSign(String requestMethod, String host, String uri,int expiresInSeconds, String queryString) {
		super();
...
//		System.out.println("CanonicalRequest: "+CanonicalRequest);
		...
		String signKeyInfo = "bce-auth-v1" + "/" + OCRConfig.accessKey + "/" + timestamp+ "/" + expiresInSeconds;
//		System.out.println("signKeyInfo: "+signKeyInfo);
		
		//将signKeyInfo与SK加密生成signingKey
		String signingKey = sha256Hex(OCRConfig.secretKey, signKeyInfo);
//		System.out.println("signingKey: "+signingKey);
		...
		String authorization = joinN("/", new String[] { "bce-auth-v1",OCRConfig.accessKey, timestamp, String.valueOf(expiresInSeconds), "host",signature });
