...
function getSigner($host,$httpMethod, $path, $parms, $timestamp) {
    ...
    $AK = "f7306cacee2942c98a715ddc0d5b3878";    //替换成你STS获取的AK
    $SK = "2cf0173d82624502bbd7150c03b5b236";    //替换成你STS获取的SK
...
$mediaId = "mda-gfyhginvv3b00rpz";  //替换成你的媒资ID
...
$head = array(
    ...
    "x-bce-security-token:{$stsSessionToken}" //通过STS授权的方式访问VOD时，需要将sts的sessionToken传入header;
);
$curlp = curl_init();
