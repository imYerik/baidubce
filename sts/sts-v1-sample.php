...
HttpUtil::__init();
function getSigner($httpMethod, $path, $parms, $timestamp) {
    //	date_default_timezone_set('UTC');
    $AK = "your Access Key";    //替换成你的AK
    $SK = "your Security Key";    //替换成你的SK
    ...
    $CanonicalHeaders2 = "host:sts.bj.baidubce.com\n" . "x-bce-date:" . urlencode($timestamp); //
...
$postdata = array(
    'id' => 'ststestid',
    'accessControlList' => json_encode(array(
        'eid' => 'acltesteid',
        'service' => 'bce:bos',
        'region' => 'bj',
        'effect' => 'Allow',
        'resource' => json_encode(array(
            'yourbucketname1/*',    //你要授权的bucketname
            'yourbucketname2'       //
        )) ,
